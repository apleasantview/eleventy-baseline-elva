...
After [adding a new language](/documentation/managing-languages/), you may want to edit your collections to add custom slug for each collection type, in the newly added language.
...
[Now lets add some translations](/documentation/managing-translations/).
